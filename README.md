...
* **ONI-Common**: Common code. Provides config load/save functionality, logger, help tools. **Required by these mods**:
  * **BuildingModifierMod**: Allows to modify building attributes. It includes: PressureDoorMod, SensorsMod, StorageLockerMod, VentPressureMod. (Config file: \Mods\BuildingModifier\Config\BuildingModifierState.json) Made by [@javisar](https://github.com/javisar).
