...
public class GasTank : StateMachineComponent<GasTank.StatesInstance>, IEffectDescriptor
{
	public class StatesInstance : GameStateMachine<States, StatesInstance, GasTank, object>.GameInstance
	{
		public StatesInstance(GasTank smi)
			: base(smi)
		{
		}
		/*
	...
	public class States : GameStateMachine<States, StatesInstance, GasTank>
	{
	...
	*/
	...
	public bool HasMaterial()
	{
		...
		*/
		this.UpdateMeter();
		return this.gasStorage.MassStored() > 0f;
	}
	...
	*/
	...
	{
		this.meter.SetPositionPercent(Mathf.Clamp01(this.gasStorage.MassStored() / this.gasStorage.capacityKg));
	}
	/*
