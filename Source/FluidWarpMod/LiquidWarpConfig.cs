...
public class LiquidWarpConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
        ...
        ValveWarpBase valveBase = go.AddOrGet<ValveWarpBase>();
		valveBase.conduitType = ConduitType.Liquid;
		valveBase.maxFlow = 10f;
		valveBase.animFlowRanges = new ValveWarpBase.AnimRangeInfo[3]
		{
			new ValveWarpBase.AnimRangeInfo(3f, "lo"),
			new ValveWarpBase.AnimRangeInfo(7f, "med"),
			new ValveWarpBase.AnimRangeInfo(10f, "hi")
		};
		go.AddOrGet<Valve>();
